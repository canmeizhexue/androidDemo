package com.canmeizhexue.common.views.scan.custom.app;
...
public class DimensCodeTools {
     ...
     */
	public static void startScan(Activity context, int customTitle) {
		Intent intent = new Intent(context, CaptureActivity.class);
		intent.putExtra(ScanParams.WHICH, ScanParams.QRCODE_FEATURES);
		intent.putExtra(ScanParams.CUSTOM_TITLE,customTitle);
		context.startActivityForResult(intent, DEFAULT_REQUEST_CODE);
	}
